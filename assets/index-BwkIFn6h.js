...
`,We=2e3,fe=6,ee=8;class Pt{constructor(e){l(this,"gl");l(this,"shader");l(this,"vao");l(this,"vertexBuffer");l(this,"vertexData");l(this,"spriteCount");l(this,"currentTexture",null);this.gl=e,this.shader=new st(e,It,Lt),this.vertexData=new Float32Array(We*fe*ee),this.spriteCount=0;const t=e.createVertexArray();if(!t)throw new Error("Failed to create VAO");this.vao=t,e.bindVertexArray(t);const s=e.createBuffer();if(!s)throw new Error("Failed to create buffer");this.vertexBuffer=s,e.bindBuffer(e.ARRAY_BUFFER,s),e.bufferData(e.ARRAY_BUFFER,this.vertexData.byteLength,e.DYNAMIC_DRAW);const i=this.shader.getAttributeLocation("a_position");e.enableVertexAttribArray(i),e.vertexAttribPointer(i,2,e.FLOAT,!1,ee*4,0);const o=this.shader.getAttributeLocation("a_texCoord");e.enableVertexAttribArray(o),e.vertexAttribPointer(o,2,e.FLOAT,!1,ee*4,2*4);const r=this.shader.getAttributeLocation("a_color");e.enableVertexAttribArray(r),e.vertexAttribPointer(r,4,e.FLOAT,!1,ee*4,4*4),e.bindVertexArray(null)}begin(e,t,s){this.shader.use(),this.gl.uniform2f(this.shader.getUniformLocation("u_resolution"),this.gl.canvas.width,this.gl.canvas.height),this.gl.uniform2f(this.shader.getUniformLocation("u_camera"),e,t),this.gl.uniform1f(this.shader.getUniformLocation("u_zoom"),s),this.spriteCount=0,this.currentTexture=null}draw(e,t,s,i,o,r=0,a=0,c=1,h=1,u=[1,1,1,1],d=0,v=0,f=0){this.currentTexture!==e&&(this.flush(),this.currentTexture=e),this.spriteCount>=We&&this.flush();const p=this.spriteCount*fe*ee;let m=-v,x=-f,g=i-v,P=-f,F=i-v,C=o-f,k=-v,T=o-f;if(d!==0){const K=Math.cos(d),Z=Math.sin(d),ht=m*K-x*Z,ut=m*Z+x*K,dt=g*K-P*Z,ft=g*Z+P*K,pt=F*K-C*Z,mt=F*Z+C*K,gt=k*K-T*Z,vt=k*Z+T*K;m=ht,x=ut,g=dt,P=ft,F=pt,C=mt,k=gt,T=vt}m+=t,x+=s,g+=t,P+=s,F+=t,C+=s,k+=t,T+=s;const[R,_,W,j]=u;this.setVertex(p+0,m,x,r,a,R,_,W,j),this.setVertex(p+8,g,P,c,a,R,_,W,j),this.setVertex(p+16,F,C,c,h,R,_,W,j),this.setVertex(p+24,m,x,r,a,R,_,W,j),this.setVertex(p+32,F,C,c,h,R,_,W,j),this.setVertex(p+40,k,T,r,h,R,_,W,j),this.spriteCount++}setVertex(e,t,s,i,o,r,a,c,h){this.vertexData[e]=t,this.vertexData[e+1]=s,this.vertexData[e+2]=i,this.vertexData[e+3]=o,this.vertexData[e+4]=r,this.vertexData[e+5]=a,this.vertexData[e+6]=c,this.vertexData[e+7]=h}flush(){if(this.spriteCount===0||!this.currentTexture)return;this.gl.bindVertexArray(this.vao),this.gl.bindBuffer(this.gl.ARRAY_BUFFER,this.vertexBuffer);const e=this.spriteCount*fe*ee;this.gl.bufferSubData(this.gl.ARRAY_BUFFER,0,this.vertexData.subarray(0,e)),this.currentTexture.bind(0),this.gl.uniform1i(this.shader.getUniformLocation("u_texture"),0),this.gl.drawArrays(this.gl.TRIANGLES,0,this.spriteCount*fe),this.spriteCount=0,this.gl.bindVertexArray(null)}}const te=32;class Xe{constructor(e){l(this,"gl");l(this,"shader");l(this,"vao");l(this,"vertexBuffer");l(this,"vertexCount",0);l(this,"mapWidth",0);l(this,"mapHeight",0);this.gl=e;const t=`#version 300 es
        in vec2 a_position;
        in vec2 a_texCoord;
        in float a_objectId;
        ...
        `,e.appendChild(this.element),this.element.addEventListener("click",s=>{s.preventDefault(),s.stopPropagation(),console.log("[LevelComplete] Click detected"),this.handleInput()}),this.element.addEventListener("touchend",s=>{s.preventDefault(),s.stopPropagation(),console.log("[LevelComplete] Touch detected"),this.handleInput()})}setOnContinue(e){this.onContinue=e}handleInput(){console.log("[LevelComplete] handleInput called, isVisible:",this.isVisible),this.isVisible&&(console.log("[LevelComplete] Calling hide and onContinue"),this.hide(),this.onContinue())}show(e){this.isVisible=!0,this.element.style.display="flex",this.element.offsetWidth,this.element.style.opacity="1",window.addEventListener("keydown",this.handleKey);const t=this.element.querySelector("#lc-level-name");t&&(t.textContent=e.levelName);const s=Math.floor(e.time*10),i=Math.floor(e.fuel),o=s+i,r=e.currentScore+o,a=r-e.levelStartScore,c=`gw_pb_level_${e.levelIndex}`,h=localStorage.getItem(c);let u=h?parseInt(h,10):0;a>u&&(u=a,localStorage.setItem(c,u.toString()));const d=u,v=this.element.querySelector("#lc-pb");v&&(v.textContent=u.toLocaleString());const f=this.element.querySelector("#lc-high");f&&(f.textContent=d.toLocaleString());const p=this.element.querySelector("#lc-base-score"),m=this.element.querySelector("#lc-time-bonus"),x=this.element.querySelector("#lc-fuel-bonus"),g=this.element.querySelector("#lc-score");p&&(p.textContent=e.currentScore.toLocaleString()),m&&(m.textContent=`+${s}`),x&&(x.textContent=`+${i}`),g&&(g.textContent=e.currentScore.toLocaleString()),console.log("[LevelComplete] Starting animation:",{currentScore:e.currentScore,timeBonus:s,fuelBonus:i,totalBonus:o,finalScore:r});const P=2e3;let F=null;const C=k=>{if(!this.isVisible){console.log("[LevelComplete] Animation stopped - not visible");return}F===null&&(F=k);const T=k-F,R=Math.min(T/P,1),_=1-Math.pow(1-R,3),W=Math.floor(o*_),j=e.currentScore+W;g&&(g.textContent=j.toLocaleString()),R<1?this.animationFrame=requestAnimationFrame(C):(g&&(g.textContent=r.toLocaleString()),console.log("[LevelComplete] Animation complete, final score:",r))};this.animationFrame&&cancelAnimationFrame(this.animationFrame),this.animationFrame=requestAnimationFrame(C)}hide(){this.isVisible=!1,window.removeEventListener("keydown",this.handleKey),this.element.style.opacity="0",this.animationFrame&&(cancelAnimationFrame(this.animationFrame),this.animationFrame=null),setTimeout(()=>{this.element.style.display="none"},300)}}const z=document.getElementById("app")??vs();function vs(){const n=document.createElement("div");return n.id="app",document.body.appendChild(n),n}console.log("[Main] App Version: 1.0.1 (Relative Paths Configured)");const O=document.createElement("canvas");O.width=960;O.height=540;O.style.width="100%";O.style.height="100%";O.style.display="block";O.style.background="#05060a";O.tabIndex=0;O.style.outline="none";z.appendChild(O);O.focus();z.addEventListener("dblclick",()=>{document.fullscreenElement?document.exitFullscreen():z.requestFullscreen().catch(n=>{console.error(`Error attempting to enable fullscreen: ${n.message}`)})});const A=new kt(O),M=document.createElement("canvas");M.style.position="absolute";M.style.top="0";M.style.left="0";M.style.width="100%";M.style.height="100%";M.style.pointerEvents="none";z.appendChild(M);const B=M.getContext("2d"),Ne=new Ft,Ve=new it("FIRE"),ze=new it("ACCEL"),Je="ontouchstart"in window||navigator.maxTouchPoints>0||window.innerWidth<768;function lt(){A.resize();const n=O.clientWidth,e=O.clientHeight;if(M.width!==n||M.height!==e){M.width=n,M.height=e;const t=20,s=60,i=64,r=s*2+20,a=t+s,c=e-t-s,h=c-r;Ve.setPosition(a,h,s),ze.setPosition(a,c,s);const u=n-t-i,d=e-t-i;Ne.setPosition(u,d,i)}}window.addEventListener("resize",lt);lt();let Ce="WASM pending build…",w=null,ke=null,V=null,b=null,S=null,E=null,L=null,re=null,q=null,ye=null,xe=null,Re=null,we=[],Fe=null,me=[],ae=!1,I=null;(async()=>I=await us(z,Ne,Ve,ze))();const Q=new St;Q.setSfxVolume(.5);let $=null,ge=null,oe=null,Ie=null,H=null,Y=!1;const ys=13;let Ue=!1,Me=-1,y=null;const le={},xs=128,G={EXPLODE_1:2,EXPLODE_2:3,EXPLODE_3:4,EXPLODE_4:5,EXPLODE_5:6,APPEAR_1:7,APPEAR_2:8,APPEAR_3:9,APPEAR_4:10,APPEAR_5:11},Be={[G.EXPLODE_1]:45,[G.EXPLODE_2]:46,[G.EXPLODE_3]:47,[G.EXPLODE_4]:48,[G.EXPLODE_5]:49,[G.APPEAR_1]:157,[G.APPEAR_2]:158,[G.APPEAR_3]:159,[G.APPEAR_4]:160,[G.APPEAR_5]:161},Se=Array.from(new Set(Object.values(Be).filter(n=>typeof n=="number"))),ws={DISAPPEARING:4};function N(n){if(!w)throw new Error("WASM runtime not ready");if(le[n])return le[n];const e=w.runtime,t=[n,`_${n}`];for(const s of t){const i=e[s];if(typeof i=="function")return le[n]=i.bind(e),le[n]}if(typeof e.cwrap=="function"){const s=e.cwrap(n,"void",[]);return le[n]=s,s}throw new Error(`Export ${n} not found on wasm runtime.`)}function bs(n,e){const s=M.width/2+e.x*.015625,i=M.height/2-e.y*.015625;n.fillStyle=e.active?"#ff0":"#777",n.beginPath(),n.arc(s,i,6,0,Math.PI*2),n.fill(),n.fillStyle="#fff",n.font="12px monospace",n.fillText(`(${e.x}, ${e.y})`,s+10,i-10)}function Ss(n,e,t,s,i){const o=[`CHEAT MODE: ${i?"ON":"OFF"}`,`Ship state: ${e.state}`,`Pos: (${e.x}, ${e.y})`,`Thrust value: ${e.thrust}`,`Fuel: ${(t==null?void 0:t.shipFuel)??"n/a"}`,`Time: ${t?t.shipTime.toFixed(1):"n/a"}`,`Life: ${(t==null?void 0:t.shipLife)??"n/a"}`,`Score: ${(t==null?void 0:t.shipScore)??"n/a"}`,`Keys: ${(t==null?void 0:t.numKeys)??"n/a"} | Level: ${(t==null?void 0:t.levelnum)??"n/a"}`,`Angle sa: ${(t==null?void 0:t.sa)??"n/a"}`,`Input thrust: ${s.thrust}`,`Input fire: ${s.fire}`,`Input rotate: ${s.rotate}`],r=280,a=16,c=o.length*a+12,h=M.width-r-12,u=12;n.fillStyle="rgba(0, 0, 0, 0.7)",n.fillRect(h,u,r,c),n.strokeStyle="#0ff",n.strokeRect(h,u,r,c),n.fillStyle="#fff",n.font="12px monospace",o.forEach((d,v)=>{n.fillText(d,h+8,u+20+v*a)})}function Es(n){return{setThrust:ce(n,"wasm_set_thrust"),setFire:ce(n,"wasm_set_fire"),adjustAngle:ce(n,"wasm_adjust_sa"),setSA:ce(n,"wasm_set_sa"),getDemoBufferPtr:Le(n,"get_demo_buffer"),getDemoCount:Le(n,"get_demo_count"),nextLevel:ne(n,"wasm_next_level"),prevLevel:ne(n,"wasm_prev_level"),restartLevel:ne(n,"wasm_restart_level"),toggleCheatMode:ne(n,"wasm_toggle_cheat_mode"),getCheatMode:Le(n,"wasm_get_cheat_mode"),addScore:ce(n,"wasm_add_score")}}function ce(n,e){const t=n,s=[e,`_${e}`];for(const i of s){const o=t[i];if(typeof o=="function")return r=>o.call(t,r)}if(n.cwrap){const i=n.cwrap(e,"void",["number"]);return o=>i(o)}throw new Error(`Unable to resolve wasm export ${e}`)}function ne(n,e){const t=n,s=[e,`_${e}`];for(const i of s){const o=t[i];if(typeof o=="function")return o.bind(t)}if(n.cwrap)return n.cwrap(e,"void",[]);throw new Error(`Unable to resolve wasm export ${e}`)}function Le(n,e){const t=n,s=[e,`_${e}`];for(const i of s){const o=t[i];if(typeof o=="function")return o.bind(t)}if(n.cwrap)return n.cwrap(e,"number",[]);throw new Error(`Unable to resolve wasm export ${e}`)}function ct(n,e){const t=e.runtime.HEAPU8;let s=n;for(;t[s]!==0;)s++;return new TextDecoder().decode(t.subarray(n,s)).replace(/"/g,"")}function De(){if(!w||!y)return;oe||(oe=new at(z)),Ue=!0,Y=!0,he(),b&&(Oe=b.read().shipScore);const n=N("get_current_level_name"),e=ct(n(),w);oe.show(e,()=>{Ue=!1})}function Ts(){var n,e;if(!(!xe||ae||!V||!S)&&V.state===ws.DISAPPEARING&&V.animationPhase<=0)if(ae=!0,S.levelnum>=ys)Ie||(Ie=new ms(z,()=>{if(y&&b){let s=b.read().levelnum;for(;s>1;)y.prevLevel(),s=b.read().levelnum;for(;s<1;)y.nextLevel(),s=b.read().levelnum;he(),De(),ae=!1}},()=>{if(Y=!1,Q.setSfxVolume(.5),$==null||$.show(),b){let s=b.read().levelnum;const i=N("wasm_prev_level");let o=0;for(;s>0&&o++<70;)i(),s=b.read().levelnum;Q.update(b.read(),[],E)}ae=!1})),Ie.show(S.shipScore);else{if(!H||typeof H.setOnContinue!="function"){if(H){try{(n=H.hide)==null||n.call(H)}catch{}try{(e=H.element)==null||e.remove()}catch{}}H=new gs(z,()=>{})}const s=S.shipTime,i=S.shipFuel,o=Math.floor(s*10),r=Math.floor(i),a=o+r;H.setOnContinue(()=>{y&&xe&&(y.addScore(a),xe(),b&&(Oe=b.read().shipScore),De(),console.log(`[LevelComplete] Added score: ${a} (Time: ${s.toFixed(1)}*10 + Fuel: ${i})`),ae=!1)});const c=N("get_current_level_name"),h=ct(c(),w);H.show({levelName:h,time:s,fuel:i,currentScore:S.shipScore,levelIndex:S.levelnum,levelStartScore:Oe})}}let Qe="",Oe=0,ie=0,X=null,J=0,ve=0;const As=new ds(({deltaMs:n})=>{if(E&&L&&!A.atlasTexture)try{A.setTileAtlas(L),A.buildLevel(E,L),console.log("[gravitywars] WebGL level built")}catch(e){console.error("Failed to build level",e)}if(!q&&(w!=null&&w.runtime))try{q=be(w.runtime,Se),A.setShipSprites(q)}catch(e){console.error("Failed to build ship sprites",e)}if(A.clear(),B&&B.clearRect(0,0,M.width,M.height),w){if(N("control")(),N("animate")(),ke&&(V=ke.read()),b){S=b.read();const e=S.levelnum,t=e%7;let s="space.jpg";switch(t){case 0:s="back5_park.JPG";break;case 1:s="back_nebula.jpg";break;case 2:s="back_park.JPG";break;case 3:s="back2_park.JPG";break;case 4:s="back3_park.JPG";break;case 5:s="back4_park.JPG";break;case 6:s="back_park.JPG";break}s!==Qe&&((!s||s==="undefined")&&(s="space.jpg"),console.log(`[Main] Switching background to: ${s} for level ${e}`),A.setBackgroundImage(`assets/backgrounds/${s}`),Qe=s),S.dynamicBlocksChanged&&(w!=null&&w.runtime&&(L=$e(w.runtime),q=be(w.runtime,Se)),E&&L&&(A.setTileAtlas(L),A.setShipSprites(q),A.buildLevel(E,L)),ye==null||ye()),Q.update(S,me,E),Y&&Me>0&&S.numKeys<=0&&(oe||(oe=new at(z)),oe.showMessage("PORTAL ACTIVATED",""),console.log("[Main] Portal activated - all keys collected")),Me=S.numKeys}if(Re&&(we=Re.read().filter(e=>e.active)),Fe&&(me=Fe.read()),y&&I){const{thrust:e,fire:t,rotate:s,nextLevel:i,prevLevel:o}=I.state,r=Je?24:16;if(Y&&!Ue)if(y.setThrust(e*r),y.setFire(t?1:0),I.state.targetAngle!==void 0&&S){const a=-I.state.targetAngle-Math.PI/2,c=S.sa%16384/16384*Math.PI*2;let h=a-c;for(;h>Math.PI;)h-=Math.PI*2;for(;h<-Math.PI;)h+=Math.PI*2;const d=h*.1/(Math.PI*2)*16384;y.adjustAngle(d)}else if(s!==0){const a=performance.now();ve===0&&(ve=a);const h=a-ve>200?2:.5;y.adjustAngle(-s*xs*h)}else ve=0;else if((S==null?void 0:S.levelnum)===0){if(!X&&(w!=null&&w.runtime)){const a=y.getDemoBufferPtr();J=y.getDemoCount(),a&&J>0&&(X=(w.runtime.HEAP32||new Int32Array(w.runtime.HEAPU8.buffer)).subarray(a>>2,(a>>2)+J*10),console.log(`[Main] Intro demo loaded: ${J} frames`))}if(X&&J>0){if(ie===0){const p=Math.floor(822);for(let m=0;m<p&&!(m>=J);m++){const x=m*10;y.setThrust(X[x+7]),y.setFire(X[x+8]),y.setSA(X[x+9]),N("control")()}ie=p}const c=ie%J*10,h=X[c+7],u=X[c+8],d=X[c+9];y.setThrust(h),y.setFire(u),y.setSA(d),ie++,ie>=J&&(y.restartLevel(),ie=0)}}if(Y&&(i&&I&&(y.nextLevel(),I.state.nextLevel=!1,he()),o&&I&&(y.prevLevel(),I.state.prevLevel=!1,he()),I.state.toggleCheat)){y.toggleCheatMode(),I.state.toggleCheat=!1;const a=y.getCheatMode();console.log(`[Main] Cheat mode ${a?"ENABLED":"DISABLED"}: No wall collision, high fuel/time`)}}if(Y&&S&&S.gameOver&&(ge||(ge=new ps(z,()=>{y==null||y.restartLevel(),he()},()=>{if(Y=!1,Q.setSfxVolume(.5),$==null||$.show(),b){let e=b.read().levelnum;const t=N("wasm_prev_level");let s=0;for(;e>0&&s++<20;)t(),e=b.read().levelnum;Q.update(b.read(),[],E)}})),ge&&S)){const e=N("get_current_level_name"),s=(i=>{const o=w.runtime.HEAPU8;let r=i;for(;o[r]!==0;)r++;return new TextDecoder().decode(o.subarray(i,r)).replace(/"/g,"")})(e());ge.show(s,S.shipScore)}}if(Ts(),E&&L)if(!re||re.length!==E.tiles.length)re=new Uint8Array(E.tiles);else{const e=[];for(let t=0;t<E.tiles.length;t++)E.tiles[t]!==re[t]&&(e.push(t),re[t]=E.tiles[t]);e.length>0&&A.updateLevel(E,L)}if(E&&A.drawWorld(E,S,V,Be),S&&V&&A.drawShip(S,V,Be),E&&A.drawWorldForeground(),we.length&&A.drawBullets(we),me.length&&L&&A.drawActions(me,L),B&&(!E&&V&&bs(B,V),S&&Y&&Rt(B,S),Je&&Y&&(Ne.render(B),Ve.render(B),ze.render(B)),(I==null?void 0:I.state.toggleDebug)??!1)){if(V){const t=y?y.getCheatMode():0;Ss(B,V,S,(I==null?void 0:I.state)??{thrust:0,fire:!1,rotate:0},!!t)}B.fillStyle="#0ff",B.font="16px monospace",B.fillText(`GravityWars WebGL - Δ=${n.toFixed(2)}ms`,20,30),B.fillStyle="#0f9",B.fillText(Ce,20,60)}w&&(I==null||I.state,void 0)});function he(){w!=null&&w.runtime&&(E=rt(w.runtime),L=$e(w.runtime),q=be(w.runtime,Se),E&&L&&(A.setTileAtlas(L),A.setShipSprites(q),A.buildLevel(E,L))),we=[],Me=-1}As.start();Ot().then(n=>{w=n,ke=$t(n.runtime),b=zt(n.runtime),E=rt(n.runtime),y=Es(n.runtime),ye=ne(n.runtime,"wasm_clear_dynamic_blocks"),xe=ne(n.runtime,"wasm_advance_level"),Re=jt(n.runtime),Fe=rs(n.runtime),N("init_gw")(),N("main_init")();let e=b.read().levelnum;console.log(`[Main] Initial level: ${e}. Setting to 0 (Attractor)...`);let t=0;const s=N("wasm_prev_level"),i=N("wasm_next_level");for(;e>0&&t<20;)s(),e=b.read().levelnum,t++;for(;e<0&&t<20;)i(),e=b.read().levelnum,t++;console.log(`[Main] Level set to: ${e}`),$||($=new fs(z,o=>{console.log(`[Main] Starting game at level ${o}`),Q.setSfxVolume(1),$==null||$.hide();const r=o;console.log(`[Main] Navigating to level ${r} (user selected ${o})...`);let a=(b==null?void 0:b.read().levelnum)??0,c=0;const h=100;for(;a!==r&&c<h;)a<r?y==null||y.nextLevel():y==null||y.prevLevel(),a=(b==null?void 0:b.read().levelnum)??0,c++;console.log(`[Main] Level navigation complete after ${c} iterations. Current Level: ${a}`),De(),Q.update(b.read(),[],E)}),$.show()),L=$e(n.runtime),console.log("DEBUG: TileAtlas created",L),q=be(n.runtime,Se),E&&L&&(A.setTileAtlas(L),A.setShipSprites(q),A.buildLevel(E,L)),Ce="WASM module ready."}).catch(n=>{Ce=`WASM unavailable: ${n.message}`,console.warn(n)});
