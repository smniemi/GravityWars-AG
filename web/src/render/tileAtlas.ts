...
function renderBlockToImageData(blockIndex: number, blockData: Uint8Array, palette: Uint8Array, imageData: ImageData) {
...
let lastDynamicData: Uint8Array | null = null;
 ...
 */
export function updateDynamicBlocks(atlas: TileAtlas, runtime: GravityWarsRuntime): boolean {
  if (!atlas.lowRes) return false;
 ...
 */
export function initializeDestructibleBlocks(_runtime: GravityWarsRuntime) {
