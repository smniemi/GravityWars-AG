...
export class SpriteBatch {
    ...
    begin(cameraX: number, cameraY: number, zoom: number) {
        this.shader.use();
    ...
    private setVertex(offset: number, x: number, y: number, u: number, v: number, r: number, g: number, b: number, a: number) {
