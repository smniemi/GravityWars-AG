...
export class TilemapRenderer {
    ...
    build(map: LevelMap, atlas: TileAtlas) {
        ...
        for (let y = 0; y < map.height; y++) {
            for (let x = 0; x < map.width; x++) {
                ...
                // Triangle 1
                vertices[ptr++] = x0; vertices[ptr++] = y0; vertices[ptr++] = u0; vertices[ptr++] = v0;
                vertices[ptr++] = x1; vertices[ptr++] = y0; vertices[ptr++] = u1; vertices[ptr++] = v0;
                vertices[ptr++] = x0; vertices[ptr++] = y1; vertices[ptr++] = u0; vertices[ptr++] = v1;

                // Triangle 2
                vertices[ptr++] = x0; vertices[ptr++] = y1; vertices[ptr++] = u0; vertices[ptr++] = v1;
                vertices[ptr++] = x1; vertices[ptr++] = y0; vertices[ptr++] = u1; vertices[ptr++] = v0;
                vertices[ptr++] = x1; vertices[ptr++] = y1; vertices[ptr++] = u1; vertices[ptr++] = v1;
            }
        }
    ...
    draw(texture: Texture, cameraX: number, cameraY: number, zoom: number) {
        this.shader.use();
