    ...
    setupButtons() {
        ...
        if (titleText) {
            const handleTitleTap = () => {
                ...
                this.titleTapTimes = this.titleTapTimes.filter(t => now - t < this.CHEAT_TIME_WINDOW_MS);
